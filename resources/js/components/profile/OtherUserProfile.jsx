...
function OtherUserProfile({ profile, liked, reload }) {
    ...
    let check_liked = uuser.likes.find((user) => user.profile_id === profile.profile_id);
...
<div style={{ height:1, width:'100%', background:"linear-gradient(to right, rgba(0,0,0,0), rgba(0,0,0,0.2), rgba(0,0,0,0)" }}></div>
                ...
                >
                    ...
                    >
                        ...
                        <Link to={`/messages-single/${profile.profile_id}`}>
                            <i
                    ...
                    <div className="flex items-center px-3 ml-8 rounded-full ring-1 ring-slate-900/5 gap-x-2 bg-zinc-100 hover:bg-red-600 hover:text-white p-2">
                        ...
                        <Link to={`/user-profile/${profile.profile_id}`} className=""><small>Profile</small></Link>
                    </div>
                </div>
            </div>
        </div>
