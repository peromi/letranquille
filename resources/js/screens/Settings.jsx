            ...
            <div className="h-screen w-full px-20 pb-4">
                {tab === 0 && (
                    <div className=" pt-4">
                        ...
                        <p>
                            Please update your email if it has changed so you do
                            not miss any communications or match alert
                        </p>
                ...
                {tab === 1 && (
                    <div className=" pt-4">
                        ...
                        <p>
                            To help keep your account secure we recommend that
                            you routinely change your password.
                        </p>
                        <p className="font-bold">
                            Important: For extra security ensure that your new
                            password is NOT the same as your email password
                        </p>
                        ...
                        <button className="p-2 px-12 rounded-full bg-red-800 text-white font-bold mt-5">
                            Upgrade Now
                        </button>
                    </div>
                )}
                    ...
                    <div className=" pt-4">
                        <div className="flex flex-col md:flex-row justify-between ">
                            <div>
                                ...
                                <p>
                                    Update your profile display options and
                                    localization.
                                </p>

                                <div>
                                    <h1 className="font-bold text-red-600 text-2xl mt-2">
                                        Online Status
                                    </h1>
                                ...
                                <div>
                                    <h1 className="font-bold text-red-600 text-2xl mt-3">
                                        Display Profile
                                    </h1>
                                ...
                                <button className="p-2 px-12 rounded-full bg-red-800 text-white font-bold mt-4">
                                    Save
                                </button>
                            </div>
                        </div>
                    ...
                    <div className=" pt-4">
                        <div className="flex flex-col md:flex-row justify-between ">
                            <div>
                                ...
                                <p>
                                    You are currently a FREE Standard member.
                                    Click <strong>"Upgrade Now"</strong> below
                                    to learn more about the benefits of becoming
                                    a paid member.
                                </p>

                                <p>
                                    Note: Auto renewal is only switched on after
                                    you have made a successful payment to
                                    upgrade membership.
                                </p>
                                <button className="p-2 px-12 rounded-full bg-red-800 text-white font-bold mt-5">
                                    Upgrade Now
                ...
                {tab === 4 && (
                    <div className=" pt-4">
                        <div className="flex flex-col md:flex-row justify-between ">
                            ...
                            <button className="p-2 px-12 rounded-full bg-red-800 text-white font-bold">
                                Change Email Address
                            </button>
                        </div>
