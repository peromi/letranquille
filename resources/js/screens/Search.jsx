...
const Search = () => {
    ...
    return (
        <MainContainer>
            ...
            <div className="md:w-full mx-auto  h-screen bg-white p-4">
                ...
                <div className="w-1/2 flex justify-between md:flex-row flex-col mt-3 gap-x-4">
                    <div className="flex-1 ">
                        <p>Country</p>
                        <select
                            className="ring-1 p-2 ring-slate-900/5 outline-0 bg-transparent w-full"
                            onChange={(e) => {
                                let result = states.filter(
                                    (s) => s.country_code == e.target.value
                                );
                    ...
                    <div className="flex-1  ">
                        ...
                        >
                            ...
                            {statesearch.map((s, index) => (
                                <option key={index} value={s.state_code}>
                                    {s.name}
                                </option>
                            ))}
                        </select>
                ...
                <button className="bg-red-600 mt-10 text-white hover:bg-red-800 p-3 px-12 rounded-md">Submit</button>
            </div>
        </MainContainer>
    );
};
