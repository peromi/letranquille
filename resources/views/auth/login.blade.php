...
<div class="bg-primary d-flex justify-content-left align-items-center vw-100 vh-100 pl-2">
   <div class="float-left ml-3">
    <div class="bg-white radius-24 login-form login-inner-form" >
        ...
        <h1 class="text-align-center mt-1 text-small-24 text-secondary">Login</h1>
        ...
        <form  action="#">
            ...
            <a class="float-right text-primary forgot" href="#">Forgot your password?</a>
            ...
            <button class="d-flex login-btn">Login</button>
